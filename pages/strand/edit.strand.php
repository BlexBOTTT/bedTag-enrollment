        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Strand Info</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-md-8">
                            <div class="card">             
                                <form action="userData/ctrl.edit.strand.php?strand_id=<?php echo $strand_id;?>" enctype="multipart/form-data" method="POST">
                                    ...
                                    <?php
                                    $strand_info = mysqli_query($conn, "SELECT * FROM tbl_strands
                                            ...
                                            <div class="row mb-4 mt-4 ">
                                                <div class="input-group col-md-6 mb-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text text-sm"><b>Subject Abj.</b></span>
                                                    </div>
                                                    <input type="text" class="form-control" name="strand_name"
                                                        placeholder="Edit Strand Abbreviation" value="<?php echo $row['strand_name']?>" required>
                                                </div>
                                                <div class="input-group col-md-6 mb-2">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" name="strand_def"
                                                        placeholder="Enter Subject Description" value="<?php echo $row['strand_def']?>" required>
                                                </div>
                                            </div>
                                        </div>
